...
! game world
  ...
  data skill(1)%name/"Forage"/ &
       ...
       &, skill(3)%name/"Heal"/ &
       &, skill(3)%dice(1,1)/1/, skill(3)%dice(1,2)/4/ &
       &, skill(3)%dice(2,1)/1/, skill(3)%dice(2,2)/6/ &
       &, skill(3)%dice(3,1)/1/, skill(3)%dice(3,2)/8/ &
       &, skill(3)%dice(4,1)/1/, skill(3)%dice(4,2)/12/ &
       &, skill(3)%dice(5,1)/1/, skill(3)%dice(5,2)/20/ &
       &  skill(4)%name/"Guard"/ &
       &, skill(4)%dice(1,1)/1/, skill(4)%dice(1,2)/20/ &
       &, skill(4)%dice(2,1)/1/, skill(4)%dice(2,2)/20/ &
       &, skill(4)%dice(3,1)/1/, skill(4)%dice(3,2)/12/ &
       &, skill(4)%dice(4,1)/1/, skill(4)%dice(4,2)/12/ &
       &, skill(4)%dice(5,1)/1/, skill(4)%dice(5,2)/6/
  ...
  data actor(1)%id/1/             , actor(1)%name/"Holde Knirbe"/ &
       ...
       &, actor(2)%skill(3)/1/    , actor(2)%skill(4)/4/ &
       &, actor(2)%action/4/ &
       ...
       &, actor(3)%skill(3)/2/    , actor(3)%skill(4)/1/ &
       &, actor(3)%action/2/ &
       ...
       &, actor(4)%skill(3)/5/    , actor(4)%skill(4)/1/ &
       &, actor(4)%action/1/
